...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    blur_img = cv2.blur(crop_img, (12, 12), cv2.BORDER_DEFAULT) 
    # nm="/content/runs/detect/exp17/"+str(np.random.randint(0,100))+'.jpg'
    # cv2.imwrite(nm,blur_img)
    img[startY:endY, startX:endX] = blur_img
